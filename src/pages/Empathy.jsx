      ...
      <section className="max-w-7xl mx-auto py-24 px-6 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            { tag: "WHERE", title: "Di Mana Masalah Terjadi?", image: "empathy-where.jpg", desc: "Di laboratorium komputer kampus, ruang kerja komunal mitra industri tempat magang, serta area belajar mandiri di rumah selama pembelajaran jarak jauh." },
