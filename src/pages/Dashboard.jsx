    ...
    <div className="min-h-screen bg-white text-slate-800 selection:bg-red-100 selection:text-red-600 overflow-x-hidden">
      ...
      <header className="relative pt-48 pb-36 px-6 border-b border-slate-100 w-full min-h-[700px] flex items-center overflow-hidden group/hero">
        ...
        <div className="relative max-w-7xl mx-auto z-20 w-full">
          <ScrollReveal variant="fade-right" duration={1000}>
      ...
      <section className="max-w-7xl mx-auto py-24 px-6 relative">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9 gap-4">
            {sdgData.map((sdg, index) => (
              ...
              >
                <Link 
                  to={sdg.path || "#"} 
                  className={`group relative rounded-2xl border transition-all duration-500 cursor-pointer overflow-hidden aspect-square shadow-sm flex items-center justify-center w-full h-full
                    ${sdg.focus 
          ...
          <div className="mt-20 border-t border-slate-100 pt-16 grid lg:grid-cols-12 gap-12 items-center">
            <ScrollReveal variant="fade-right" className="lg:col-span-8 space-y-6">
            ...
            <ScrollReveal variant="fade-left" className="lg:col-span-4 flex justify-center">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <ScrollReveal key={idx} variant="fade-up" delay={idx * 100} duration={600} className="h-full">
                  <div className="group bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm transition-all duration-500 hover:shadow-xl hover:border-red-100 hover:-translate-y-1 flex flex-col justify-between h-full">
                    <div>
      ...
      <section className="max-w-7xl mx-auto pb-24 px-6 relative">
        <div className="grid md:grid-cols-2 gap-8">
          <ScrollReveal variant="fade-up" delay={0} duration={800} className="h-full">
            <div className="group/why bg-white p-6 md:p-8 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col justify-between hover:shadow-xl hover:border-red-100 hover:-translate-y-2 transition-all duration-500 h-full">
              <div>
          ...
          <ScrollReveal variant="fade-up" delay={150} duration={800} className="h-full">
            <div className="group/target bg-gradient-to-br from-slate-50 via-white to-red-50/10 p-6 md:p-8 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col justify-between hover:shadow-xl hover:border-red-100 hover:-translate-y-2 transition-all duration-500 h-full">
              <div>
                <div className="w-full h-52 bg-slate-100 rounded-[2rem] mb-6 overflow-hidden border border-slate-100 shadow-inner relative">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                <ScrollReveal key={idx} variant="fade-up" delay={idx * 60} duration={600} className="h-full">
                  <div className="group/card bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col justify-between hover:shadow-xl hover:border-red-100 hover:-translate-y-2 transition-all duration-500 h-full">
                    <div>
