      ...
      <main className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7">
          ...
          <div className="grid gap-3">
            {targets.map((target, idx) => (
              <div key={idx} className="group p-6 rounded-3xl border border-slate-100 bg-white hover:border-red-100 hover:shadow-xl hover:shadow-red-500/5 transition-all duration-500">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-8 rounded-[2rem] border border-slate-100 bg-white shadow-sm hover:shadow-lg transition-all text-center group">
